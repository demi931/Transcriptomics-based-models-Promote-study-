...
```{r}
expr_file <- "data/input/PROMOTE2samplechangeRR60samples.csv"
...
# Add Location as a factor (CRUCIAL)
plotdat$Location <- as.factor(data1[, "Location"])
...
data <- read.csv("data/input/log2J.csv", row.names=1)
...
data <- read.csv("data/input/log2JRR.csv", row.names=1)
...
data <- read.csv("data/input/20260128stagepcacbr.csv", row.names=1)
...
data <- read.csv("data/input/20260128stagepca.csv", row.names=1)
stage_vec <- as.numeric(data["stage", ])
...
RFE_CBR <- readRDS("data/input/5clinicRFE_CBR.rds")
...
### 5 clinic+wholeDEGS
RFE_CBR <- readRDS("data/input/5clinic+wholeDEGSRFE_CBR.rds")
...
#### 97genesCBR
RFE_CBR <- readRDS("data/input/DEGSRFE_CBR.rds")
...
RFE_CBR <- readRDS("data/input/202512185clinic+selectedDEGSRFE_CBR.rds")
...
RFE_RR <- readRDS("data/input/5clinicRFE_RR.rds")
...
RFE_RR <- readRDS("data/input/wholedegsRR+5clinicRFE_RR.rds")
...
RFE_RR <- readRDS("data/input/20251218selecteddegsRR+5clinicRFE_RR.rds")
