...
knitr::opts_knit$set(root.dir = 'C:/Users/rianne.fijten/Documents/GitHub/PROMOTE/') ## fixed directory assigning
...
```{r}
data <- read.csv("CODE/PROMOTE2samplechangeRR60samples.csv", row.names=1)
...
plotdat$genotype <- paste0(
  "Location",
  match(plotdat$genotype, unique(plotdat$genotype))
)

#Create a scatter plot with ellipses.

ggplot(plotdat, aes(x=PC1, y=PC2, colour=genotype)) +
  geom_point(size=3) +  
