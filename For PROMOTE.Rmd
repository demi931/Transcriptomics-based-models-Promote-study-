...
We use "5clinic+wholeDEGS" model as an example. Extract selected features from the chosen logistic model
...
# Continuous variables (selected features can be changed by different models)
continuous_vars <- c(
  "ENSG00000127554","Age","ENSG00000134216",
  "ENSG00000198881","ENSG00000285854"
)

# Categorical variables (selected features can be changed by different models)
...
# continuous-variable p-values (Wilcoxon)
p_df <- plot_df_long %>%
